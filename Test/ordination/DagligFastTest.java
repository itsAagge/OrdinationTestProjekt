...
class DagligFastTest {
    ...
    @Test
    void samletDosisSammeDag() {
        Patient pas = new Patient("123456-7890", "Anders Handsen", 85);
        Laegemiddel middel = new Laegemiddel("Paracetamol",2, 2, 2, "Pille");
        DagligFast ordination = controller.opretDagligFastOrdination(LocalDate.of(2024,7,19),LocalDate.of(2024,7,19), pas, middel,1,1,1,1);
        assertEquals(4, ordination.samletDosis());
    }
    ...
    void doegnDosis() {
        ...
        Laegemiddel middel = new Laegemiddel("Paracetamol",2, 2, 2, "Pille");
        DagligFast ordination = controller.opretDagligFastOrdination(LocalDate.of(2024,7,13),LocalDate.of(2024,7,19), pas, middel,1,1,1,1);
        assertEquals(4, ordination.doegnDosis());
